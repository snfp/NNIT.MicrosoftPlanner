...
{
    [LocalizedDisplayName(nameof(Resources.DeleteBucket_DisplayName))]
    [LocalizedDescription(nameof(Resources.DeleteBucket_Description))]
    public class DeleteBucket : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        [LocalizedDisplayName(nameof(Resources.DeleteBucket_Id_DisplayName))]
        [LocalizedDescription(nameof(Resources.DeleteBucket_Id_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> Id { get; set; }

        [LocalizedDisplayName(nameof(Resources.DeleteBucket_Etag_DisplayName))]
        [LocalizedDescription(nameof(Resources.DeleteBucket_Etag_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> ETag { get; set; }

        [LocalizedDisplayName(nameof(Resources.DeleteBucket_StatusCode_DisplayName))]
        [LocalizedDescription(nameof(Resources.DeleteBucket_StatusCode_Description))]
        ...
        public DeleteBucket()
        {
            Constraints.Add(ActivityConstraints.HasParentType<DeleteBucket, PlannerScope>(string.Format(Resources.ValidationScope_Error, Resources.PlannerScope_DisplayName)));
        }
        ...
        protected override async Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken)
        {
            ...
            Console.WriteLine("Bucket was deleted");
            // Outputs
            return (ctx) => {
